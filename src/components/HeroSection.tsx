...
// Import custom Button component and router Link
...
const HeroSection: React.FC = () => {
  return (
    // Section wrapper with background and text color
        ...
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button 
              ...
              size="lg" 
              variant="outline" 
              className="text-md bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20"
            >
              <Link to="/contact">
